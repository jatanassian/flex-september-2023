...
describe('doShortly', function () {
	...
	before(() => {
		console.log(
			`LHL Note: "Timeout of 2000ms exceeded..." is a generic message from Mocha if our delayed execution doesn't happen.`
		);
		console.log(
			`           Mocha waits 2 seconds (by default) before giving up on the test. This error should go away once the callback is invoked.`
		);
	});
